...
export default class Modal3 extends LitElement{
    ...
    render(){
        ...
        <div class="padremodal">
                <div class="modal">
                    <h1 class="text-movimiento">Movimiento 3</h1>
                <div class= descripcion>
                    <h2>Descripción</h2>
                </div>
                <div class= "compra">
                    <p>
                        Sucursal OXXO Reforma
                    </p>
                    <h4 class= "descripCompra">Bolsa de Hielos iglu</h4>
                    <h4 class= "descripCompra" >$31 </h4>

                    <h4 class="descripCompra" >Whisky Chivas Regal 12 </h4>
    
                    <h4 class= "descripCompra">$915 </h4>
                    
                      <h4 class= "descripCompra">Pago con Targeta </h4>
                      <h4 class= "descripCompra">$946 </h4>
                </div>
                    <p class=" cantidad">$ 946</p>
                <div class= "regresar">
